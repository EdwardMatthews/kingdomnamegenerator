        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <li>
              ...
              <li>
                <a 
                  href="https://news.ycombinator.com/item?id=43527452" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors group flex items-center"
                >
              ...
              <li>
                <a 
                  href="https://www.reddit.com/r/ObsidianMD/comments/1jkmdx9/tool_to_convert_pdf_to_markdown_and_keep_all_the/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors group flex items-center"
                >
              ...
              <li>
                <a 
                  href="https://link.zhihu.com/?target=https%3A%2F%2Fpdftomarkdown.pro/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors group flex items-center"
                >
              ...
              <li>
                <a 
                  href="https://dramatic-tulip-5f3.notion.site/Stop-Fighting-PDFs-Convert-to-Clean-Markdown-Effortlessly-Online-1c76e599062b80789ac5cd21ff9e4cf9" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors group flex items-center"
                >
              ...
              <li>
                <a 
                  href="https://matthewss-organization.gitbook.io/pdftomarkdown" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors group flex items-center"
                >
